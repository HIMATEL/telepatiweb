...
return (
    <div className="relative pt-32 pb-20 md:pt-40 md:pb-24 px-6 overflow-hidden max-w-6xl mx-auto min-h-[90vh] flex flex-col items-center justify-center">
      ...
      {/* Logo */}
      <div className="hero-logo-reveal mb-10 w-75 h-75 md:w-[450px] md:h-[450px] flex items-center justify-center rounded-full overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto hero-text-reveal">
        ...
        <p className="font-(family-name:--font-inter) text-base md:text-[18px] leading-[1.6] text-on-surface-variant max-w-2xl mx-auto mb-10">
