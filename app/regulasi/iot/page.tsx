  ...
  const timelineEvents = [
    {
      ...
      desc: "Submit tim dan dokumen ide awal."
    },
    {
      date: "15 Okt 2024",
      title: "Pengumuman Finalis",
      desc: "10 tim terbaik lolos ke babak final."
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center text-left">
          <div className="col-span-1 md:col-span-7 space-y-6">
            ...
            <h1 className="font-(family-name:--font-jakarta) text-[40px] md:text-[64px] leading-[1.1] font-extrabold text-[#082016] tracking-tight">
              Regulasi IoT Agriculture
            </h1>
            <p className="font-(family-name:--font-inter) text-[18px] leading-[1.6] text-[#3e4a3e] max-w-2xl">
              Panduan lengkap, syarat teknis, dan kriteria penilaian untuk kompetisi Internet of Things (IoT) bidang pertanian di Telepati 8.0. Siapkan inovasi terbaik tim Anda untuk masa depan agrikultur pintar.
            </p>
          ...
          <div className="col-span-1 md:col-span-5 h-[400px] rounded-xl border-2 border-[#082016] overflow-hidden relative shadow-[4px_4px_0px_#082016]">
            ...
            <img 
              src="https://images.unsplash.com/photo-1586771107445-d3afcb0de51f?q=80&w=1470&auto=format&fit=crop" 
        ...
        <div className="col-span-1 md:col-span-9 space-y-12">
          ...
          <ScrollReveal id="syarat" className="bento-card rounded-xl p-8 md:p-12 border-2 border-[#082016] bg-[#e8fff0]">
            ...
            <ul className="space-y-4 font-(family-name:--font-inter) text-[16px] text-[#3e4a3e]">
              <li className="flex items-start gap-3">
                ...
                <span>Peserta adalah mahasiswa aktif program S1/D4/D3 dari seluruh perguruan tinggi di Indonesia.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#006b30] mt-1">✓</span>
                <span>Setiap tim terdiri dari 2-3 orang yang berasal dari perguruan tinggi yang sama.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#006b30] mt-1">✓</span>
                <span>Karya inovasi IoT yang diajukan belum pernah menjuarai kompetisi tingkat nasional maupun internasional sebelumnya.</span>
              </li>
            </ul>
          </ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border-2 border-[#082016] rounded-lg p-6 shadow-[3px_3px_0px_#082016]">
                <h4 className="font-(family-name:--font-jakarta) text-[20px] font-bold mb-3 flex items-center gap-2">
                  <span className="text-[#006b30]">⚙️</span> Hardware
                </h4>
                <p className="font-(family-name:--font-inter) text-[14px] text-[#3e4a3e]">
                  Bebas menggunakan mikrokontroler (ESP32, Arduino, Raspberry Pi, dll). Prototipe harus aman digunakan di lingkungan pertanian.
                </p>
              </div>
              <div className="bg-white border-2 border-[#082016] rounded-lg p-6 shadow-[3px_3px_0px_#082016]">
                <h4 className="font-(family-name:--font-jakarta) text-[20px] font-bold mb-3 flex items-center gap-2">
                  <span className="text-[#006b30]">🌡️</span> Sensor & Aktuator
                </h4>
                <p className="font-(family-name:--font-inter) text-[14px] text-[#3e4a3e]">
                  Wajib mengimplementasikan minimal 2 jenis sensor terkait pertanian (kelembapan tanah, suhu, pH, dll).
                </p>
              </div>
            </div>
          </ScrollReveal>
            ...
            <div className="space-y-6">
              <div>
                <div className="flex justify-between font-(family-name:--font-inter) text-[16px] font-bold text-[#082016] mb-2">
                  <span>Inovasi & Relevansi</span>
                  <span>35%</span>
                </div>
                <div className="w-full bg-white border-2 border-[#082016] rounded-full h-4 overflow-hidden">
                  <div className="bg-[#006b30] h-full" style={{ width: "35%" }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between font-(family-name:--font-inter) text-[16px] font-bold text-[#082016] mb-2">
                  <span>Eksekusi Teknis</span>
                  <span>40%</span>
                </div>
                <div className="w-full bg-white border-2 border-[#082016] rounded-full h-4 overflow-hidden">
                  <div className="bg-[#fdc425] h-full" style={{ width: "40%" }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between font-(family-name:--font-inter) text-[16px] font-bold text-[#082016] mb-2">
                  <span>Dampak Solusi</span>
                  <span>25%</span>
                </div>
                <div className="w-full bg-white border-2 border-[#082016] rounded-full h-4 overflow-hidden">
                  <div className="bg-[#058c42] h-full" style={{ width: "25%" }}></div>
                </div>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal id="hadiah" className="bg-[#082016] border-2 border-[#082016] rounded-xl p-8 md:p-12 text-center shadow-[4px_4px_0px_#006b30] relative overflow-hidden">
            ...
            <p className="font-(family-name:--font-inter) text-[18px] text-white/80 max-w-xl mx-auto mb-8 relative z-10">
              Raih kesempatan memenangkan hadiah tunai Rp 10.000.000, piala, dan sertifikat penghargaan.
            </p>
